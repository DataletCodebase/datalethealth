...
const values = [
  {
    label: "Patient-First Design",
    desc: "Every feature built around real patient and provider workflows.",
  },
  {
    label: "Radical Transparency",
    desc: "Open, explainable AI — no black boxes in clinical decisions.",
  },
  {
    label: "Continuous Innovation",
    desc: "We iterate rapidly with our clinical advisory board at every stage.",
  },
  {
    label: "Global Reach",
    desc: "Operating across 40+ jurisdictions with local data sovereignty.",
  },
];
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-24 items-center">
          ...
          >
            ...
            <p className="text-[#5A5A72] text-lg leading-relaxed mb-5">
              Datalet was founded with a singular mission — to close the gap
              between healthcare data and meaningful clinical action.
            </p>
            <p className="text-[#9898A8] text-sm leading-relaxed mb-12">
              Our team of physicians, data scientists, and engineers partners
              with health systems, payers, and life science companies to turn
              fragmented data into clear, actionable insights that drive better
              patient outcomes.
            </p>
              ...
              {values.map((v, i) => (
                ...
                >
                  ...
                  >
                    ...
                    />
                    <div className="font-semibold text-[#0D0D0D] text-sm mb-1.5">
                      {v.label}
                    </div>
                    <div className="text-[#9898A8] text-xs leading-relaxed">
                      {v.desc}
                    </div>
                  </motion.div>
                </TiltCard>
          ...
          >
            <div
              className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-64 h-64 rounded-full opacity-15 blur-[80px] pointer-events-none"
              style={{
              ...
              <ParallaxLayer speed={0.15}>
                <motion.div
                  ...
                  whileHover={{
                    y: -6,
                    scale: 1.06,
                    boxShadow: "0 20px 50px rgba(139,0,220,0.35)",
                  }}
            ...
            <div className="absolute bottom-4 left-4 sm:-bottom-6 sm:-left-6 z-20">
              <ParallaxLayer speed={0.08}>
                <motion.div
                  ...
                  whileHover={{
                    y: -5,
                    boxShadow: "0 16px 40px rgba(139,0,220,0.14)",
                  }}
                ...
                >
                  ...
                  <div className="px-4 flex flex-col justify-center">
                    ...
                    <div className="text-[#0D0D0D] text-sm font-bold">
