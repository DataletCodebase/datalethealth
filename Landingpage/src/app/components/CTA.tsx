...
const imgDoctorPortrait =
  "https://images.unsplash.com/photo-1758691461516-7e716e0ca135?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&q=80&w=1080";
const imgPatient =
  "https://images.unsplash.com/photo-1765222385062-11262da1ff2e?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&q=80&w=1080";
// Replaced nurse → healthcare AI tech visual
const imgAIHeath =
  "https://images.unsplash.com/photo-1745591915039-d2b1962483d4?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&q=80&w=1080";

const trustAvatars = [doctor1, doctor2, doctor3];

const programs = [
  {
    title: "12-Week Metabolic Reset",
    subtitle: "Diabetes & Hypertension",
    desc: "AI-guided programme combining continuous glucose monitoring, personalised nutrition, and weekly physician check-ins.",
    img: imgDoctorPortrait,
    accent: "#8B00DC",
  },
  {
    title: "GLP-1 Weight Management",
    subtitle: "Obesity & Pre-Diabetes",
    desc: "Medication-assisted weight programme with integrated behavioural coaching, food logging, and outcomes tracking.",
    img: imgPatient,
    accent: "#AA00FF",
  },
];
          ...
          <div className="grid lg:grid-cols-2">
            ...
            <div className="relative overflow-hidden min-h-[300px] sm:min-h-[440px] lg:min-h-[520px]">
              ...
              <div
                ...
                style={{
                  background:
                    "linear-gradient(150deg, #4A0088 0%, #8800CC 45%, #BB00EE 100%)",
                }}
              />
              ...
              <motion.div
                ...
                style={{
                  background:
                    "radial-gradient(circle, #DD88FF, transparent 60%)",
                }}
              />
              ...
              <div className="relative z-10 p-8 sm:p-10 lg:p-16 h-full flex flex-col justify-between">
                <div>
                  ...
                  <p className="text-white/60 text-sm leading-relaxed mb-8 sm:mb-12">
                    Full platform access with your own data. No commitment, no
                    credit card. A dedicated implementation specialist from day
                    one.
                  </p>
                </div>
                ...
                <div className="pt-8 border-t border-white/20 flex items-center gap-4">
                  ...
                  <p className="text-white/50 text-xs">
                    Join 10+ health systems already using Datalet
                  </p>
                </div>
              </div>
            </div>
                ...
                {submitted ? (
                  ...
                  >
                    ...
                    {[
                      {
                        text: "You're In!",
                        cls: "text-2xl font-black text-[#0D0D0D] mb-3",
                      },
                      {
                        text: "We'll reach out within one business day to schedule your personalised demo.",
                        cls: "text-[#5A5A72] text-sm max-w-xs",
                      },
                    ].map(({ text, cls }, i) => (
                      <motion.p
                        key={i}
                  ...
                  <motion.div
                    ...
                    exit={{ opacity: 0 }}
                  >
                    <h3 className="text-xl font-bold text-[#0D0D0D] mb-8">
                      Request a Demo
                    </h3>
                    <form onSubmit={submit} className="space-y-5">
                      <div className="grid grid-cols-2 gap-4">
                        {[
                          ...
                          <div key={field}>
                            <label className="block text-xs text-[#9898A8] mb-2 font-medium">
                              {label}
                            </label>
                            <motion.input
                              whileFocus={{
                                scale: 1.01,
                                borderColor: "rgba(139,0,220,0.45)",
                              }}
                              type="text"
                              required
                      ...
                      <p className="text-xs text-center text-[#C4B8D8]">
