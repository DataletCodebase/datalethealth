...
const imgPatient =
  "https://images.unsplash.com/photo-1765222385062-11262da1ff2e?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxoYXBweSUyMHBhdGllbnQlMjByZWNvdmVyeSUyMHNtaWxpbmclMjBob3NwaXRhbHxlbnwxfHx8fDE3NzE5NDYxODF8MA&ixlib=rb-4.1.0&q=80&w=1080";
...
const features = [
  {
    ...
    description:
      "Physicians and patients access a unified platform — from EHR data to patient-reported outcomes, all in one secure workspace.",
    detail: "Role-based access · Mobile-first · Offline capable",
    accent: "#8B00DC",
    Icon: LayoutDashboard,
  },
  {
    id: "02",
    title: "AI-Powered Trend Engine",
    description:
      "Our models surface clinical patterns and anomalies across your patient population before they become critical events.",
    detail: "Risk scoring · Predictive alerts · Cohort analysis",
    accent: "#AA00FF",
    Icon: TrendingUp,
  },
  {
    id: "03",
    title: "Doctor's AI Clone",
    description:
      "Personalised AI models trained on clinical guidelines and patient history to support evidence-based care decisions at scale.",
    detail: "Custom models · EHR-integrated · Explainable AI",
    accent: "#7B00CC",
    Icon: BrainCircuit,
  },
];
        ...
        {/* <div className="grid md:grid-cols-3 gap-6 mb-16 sm:mb-24 lg:mb-32">
          {features.map((f, i) => (
            <motion.div
              ...
              whileHover={{
                y: -6,
                boxShadow: "0 24px 48px rgba(139,0,220,0.10)",
              }}
            ...
            >
              <motion.div
                ...
                style={{
                  background: `linear-gradient(135deg, ${f.accent}ee 0%, ${f.accent}88 100%)`,
                }}
              >
              ...
              <p className="text-[#5A5A72] text-sm leading-relaxed mb-8">
                {f.description}
              </p>
              <div className="pt-5 border-t border-[#8B00DC]/[0.07] text-[#C4B8D8] text-xs">
                {f.detail}
              </div>
            </motion.div>
          ))}
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-24">
          {solutions.map((item, i) => (
            <motion.div
              ...
              className="bg-white rounded-3xl overflow-hidden border border-[#E8E0F5] hover:border-[#8B00DC]/30 transition-all shadow-lg shadow-[#8B00DC]/10"
            >
              {/* ✅ IMAGE SECTION (FIXED) */}
              <div className="w-full h-48 bg-[#FAF7FF] flex items-center justify-center">
                <img
                  src={item.img}
                  alt={item.title}
          ...
          <div className="grid lg:grid-cols-3 gap-6 items-start">
            ...
            <div className="space-y-5">
              ...
              <motion.div
                ...
                style={{
                  background:
                    "linear-gradient(135deg, #5B0099 0%, #9500CC 50%, #CC00EE 100%)",
                }}
              >
                {/* Glow orb */}
                <div
                  className="absolute -bottom-8 -right-8 w-32 h-32 rounded-full opacity-30 blur-2xl"
                  style={{
                    background:
                ...
                <div className="relative z-10">
                  <div className="text-white font-black text-2xl mb-2 leading-tight">
                    Personalised
                    <br />
                    Food Logging
                  </div>
